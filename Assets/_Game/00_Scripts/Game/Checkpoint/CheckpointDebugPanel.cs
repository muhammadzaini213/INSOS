...
namespace Slafurry.Game.Checkpoint
{
    ...
    public class CheckpointDebugPanel : MonoBehaviour
    {
        ...
        public void TestSaveSection1()
        {
            ...
            UnityEngine.Debug.Log("✓ Saved checkpoint: Section 1, Scene '05_Section 1'");
        }
        
        public void TestSaveSection2()
        {
            CheckpointManager.Instance.SaveCheckpoint(2, "02_Section 2");
            UnityEngine.Debug.Log("✓ Saved checkpoint: Section 2, Scene '02_Section 2'");
        }
        
        public void TestSaveSection3()
        {
            CheckpointManager.Instance.SaveCheckpoint(3, "03_Section 3");
            UnityEngine.Debug.Log("✓ Saved checkpoint: Section 3, Scene '03_Section 3'");
        }
        ...
        public void TestLoadSection1()
        {
            ...
            if (data != null)
                UnityEngine.Debug.Log($"✓ Section 1 checkpoint: {data.sceneName} | Gender: {data.gender} | {data.GetTimestampText()}");
            else
                UnityEngine.Debug.Log("❌ No checkpoint for Section 1");
        }
        ...
        public void TestLoadSection2()
        {
            ...
            if (data != null)
                UnityEngine.Debug.Log($"✓ Section 2 checkpoint: {data.sceneName} | Gender: {data.gender} | {data.GetTimestampText()}");
            else
                UnityEngine.Debug.Log("❌ No checkpoint for Section 2");
        }
        ...
        public void TestLoadSection3()
        {
            ...
            if (data != null)
                UnityEngine.Debug.Log($"✓ Section 3 checkpoint: {data.sceneName} | Gender: {data.gender} | {data.GetTimestampText()}");
            else
                UnityEngine.Debug.Log("❌ No checkpoint for Section 3");
        }
        ...
        {
            UnityEngine.Debug.Log($"Section 1 has checkpoint: {CheckpointManager.Instance.HasCheckpoint(1)}");
            UnityEngine.Debug.Log($"Section 2 has checkpoint: {CheckpointManager.Instance.HasCheckpoint(2)}");
            UnityEngine.Debug.Log($"Section 3 has checkpoint: {CheckpointManager.Instance.HasCheckpoint(3)}");
            UnityEngine.Debug.Log($"Last played section: {CheckpointManager.Instance.GetLastPlayedSection()}");
        }
        ...
        {
            string scene = CheckpointManager.Instance.GetSceneToLoad(1);
            UnityEngine.Debug.Log($"Navigating to Section 1: {scene}");
        ...
        {
            string scene = CheckpointManager.Instance.GetSceneToLoad(2);
            UnityEngine.Debug.Log($"Navigating to Section 2: {scene}");
            SceneSystem.Load(scene);
        }
        ...
        {
            string scene = CheckpointManager.Instance.GetSceneToLoad(3);
            UnityEngine.Debug.Log($"Navigating to Section 3: {scene}");
            SceneSystem.Load(scene);
        }
