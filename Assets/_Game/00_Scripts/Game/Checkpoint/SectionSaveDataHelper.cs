...
namespace Slafurry.Game
{
    ...
    public class SectionSaveDataHelper : MonoBehaviour
    {
        ...
        public void LoadSectionData()
        {
            ...
            {
                Debug.LogError("[SectionSaveDataHelper] CheckpointManager not initialized!");
                return;
            }
            ...
            if (showDebugLogs)
                Debug.Log($"[SectionSaveDataHelper] Loaded save data for Section {section}");
        }
        ...
        public void SaveSectionData()
        {
            ...
            if (_saveData == null)
            {
                Debug.LogWarning("[SectionSaveDataHelper] No data to save!");
                return;
            }
            ...
            if (showDebugLogs)
                Debug.Log($"[SectionSaveDataHelper] Saved data for Section {section}");
        }
        ...
        public void MarkSceneCompleted(string sceneName)
        {
            if (_saveData == null)
            {
                Debug.LogWarning("[SectionSaveDataHelper] Save data not loaded!");
                return;
            }
            ...
            if (!_saveData.completedScenes.Contains(sceneName))
            {
                ...
                if (showDebugLogs)
                    Debug.Log($"[SectionSaveDataHelper] Scene '{sceneName}' marked as completed");
            }
        }
        ...
        public void CollectItem(string itemId)
        {
            ...
            if (!_saveData.collectedItems.Contains(itemId))
            {
                ...
                if (showDebugLogs)
                    Debug.Log($"[SectionSaveDataHelper] Item '{itemId}' collected");
            }
        }
        ...
        public void CompleteTask(string taskId)
        {
            ...
            if (!_saveData.completedTasks.Contains(taskId))
            {
                ...
                if (showDebugLogs)
                    Debug.Log($"[SectionSaveDataHelper] Task '{taskId}' completed");
            }
        }
        ...
        public void IncrementTaskProgress(string taskId, int amount = 1)
        {
            ...
            if (showDebugLogs)
                Debug.Log($"[SectionSaveDataHelper] Task '{taskId}' progress: {_saveData.taskProgress[taskId]}");
        }
        ...
        public void SetFlag(string flagId, bool value)
        {
            ...
            if (showDebugLogs)
                Debug.Log($"[SectionSaveDataHelper] Flag '{flagId}' = {value}");
        }
        ...
        public void IncrementDeathCount()
        {
            ...
            if (showDebugLogs)
                Debug.Log($"[SectionSaveDataHelper] Death count: {_saveData.deathCount}");
        }
        ...
        public void IncrementHintsUsed()
        {
            ...
            if (showDebugLogs)
                Debug.Log($"[SectionSaveDataHelper] Hints used: {_saveData.hintsUsed}");
        }
        ...
        public void SetSectionCompleted(bool completed)
        {
            ...
            if (showDebugLogs)
                Debug.Log($"[SectionSaveDataHelper] Section {section} completed: {completed}");
        }
        ...
        public void SetProgress(float percentage)
        {
            ...
            if (showDebugLogs)
                Debug.Log($"[SectionSaveDataHelper] Progress: {_saveData.progressPercentage:F1}%");
        }
